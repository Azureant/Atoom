	...
	squareControls.forEach((control, i) => {
		control.addEventListener("mouseenter", function() {
			if (i == 0) {
				...
				square.style.minHeight = "439px";
				square.style.minWidth = "439px";
				square.style.borderRadius = "60px";
			} else if (i == 1) {
				square.style.borderColor = "#DB00FF";
				square.style.minHeight = "292px";
				square.style.minWidth = "292px";
				square.style.borderRadius = "60px";
			} else if (i == 2) {
				...
				square.style.borderColor = "#006CFF";
				square.style.minHeight = "142px";
				square.style.minWidth = "142px";
				...
				square.style.borderColor = "#FFFFFF";
				square.style.minHeight = "75px";
				square.style.minWidth = "75px";
